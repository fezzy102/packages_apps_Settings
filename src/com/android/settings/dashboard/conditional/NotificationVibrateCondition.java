...
public class NotificationVibrateCondition extends AbnormalRingerConditionBase {

    NotificationVibrateCondition(ConditionManager manager) {
        super(manager);
    }
    ...
    public Drawable getIcon() {
        return mManager.getContext().getDrawable(R.drawable.ic_volume_notification_vibrate);
    }
